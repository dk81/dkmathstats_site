...
# <u>The FOIL Method For Multiplying Two Binomials</u>
...
(1.1) $$ \displaystyle (a + b) \times (c + d) = ac + ad + bc + bd $$
...
From (1.1) the first terms are $a$ and $c$ so we get $ac$ as the first term.
