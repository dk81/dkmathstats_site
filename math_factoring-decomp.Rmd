...
The decomposition method is somewhat similar to factoring quadratics when $a = 1$ in $y = ax^2 + bx + c$. When $a$ is something like 2,7 or 10, it is more preferable to using the decomposition factoring method.
