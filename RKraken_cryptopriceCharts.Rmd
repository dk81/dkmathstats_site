...
The [blog post](https://www.cryptodatadownload.com/blog/how-to-download-kraken-data-R.html) from Crypto Download contains template code for obtain crypto price data from the Kraken exchagne and writing it to a .csv file given a crypto trading pair. 
